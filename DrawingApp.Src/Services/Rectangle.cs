...
namespace DrawingApp.Services
{
    public class Rectangle: AbstractShape
    {
        ...
        public override void Initialize(string[] input)
        {
            if (input.Length != 5)
            {
                throw new ArgumentException("Rectangle creation string must have 5 arguments");
            }
        ...
        public override void Draw()
        {
            ...
            DrawLine(_x1, _y1,_x2, _y1,'x', 1);
            DrawLine(_x1, _y2, _x2, _y2, 'x', 1);
            DrawLine(_x1, _y1, _x1, _y2, 'x', 1);
            DrawLine(_x2, _y1, _x2, _y2, 'x', 1);
        }
    }
}
